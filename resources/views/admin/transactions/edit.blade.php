                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('transaction.update', $transaction->id) }}">
                            ...
                            <div class="row">
                                <div class="form-group col-lg-4">
                                    ...
                                    <input type="text" class="form-control digit_only @error('adult') is-invalid @enderror"
                                        name="adult" id="adult" value="{{ $transaction->adult }}">
                                    @error('adult')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="form-group col-lg-4">
                                    ...
                                    <input type="text" class="form-control digit_only @error('kids') is-invalid @enderror"
                                        name="kids" id="kids" value="{{ $transaction->kids }}">
                                    @error('kids')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="form-group col-lg-4">
                                    ...
                                    <input type="text" class="form-control digit_only @error('senior') is-invalid @enderror"
                                        name="senior" id="senior" value="{{ $transaction->senior }}">
                                    @error('senior')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="form-group col-lg-6">
                                    ...
                                    <div class="selectgroup selectgroup-pills">
                                        <label class="selectgroup-item">
                                            <input type="radio" name="types" value="1" class="selectgroup-input" {{ $transaction->type_id == 1 ? 'checked' : ''  }}>
                                            <span class="selectgroup-button selectgroup-button-icon"><i
                                                    class="fas fa-sun"></i> Day</span>
                                        </label>
                                        <label class="selectgroup-item">
                                            <input type="radio" name="types" value="2" class="selectgroup-input" {{ $transaction->type_id == 2 ? 'checked' : ''  }}>
                                            <span class="selectgroup-button selectgroup-button-icon"><i
                                                    class="fas fa-moon"></i> Night</span>
                                        </label>
                                        <label class="selectgroup-item">
                                            <input type="radio" name="types" value="3" class="selectgroup-input" {{ $transaction->type_id == 3 ? 'checked' : ''  }}>
                                            <span class="selectgroup-button selectgroup-button-icon"><i
                                ...
                                <div class="form-group col-lg-6">
                                    ...
                                    <div class="selectgroup selectgroup-pills">
                                        <label class="selectgroup-item">
                                            <input type="radio" name="breakfast" value="1" class="selectgroup-input" {{ $transaction->is_breakfast == 1 ? 'checked' : ''  }}>
                                            <span class="selectgroup-button selectgroup-button-icon">Yes</span>
                                        </label>
                                        <label class="selectgroup-item">
                                            <input type="radio" name="breakfast" value="0" class="selectgroup-input" {{ $transaction->is_breakfast == 0 ? 'checked' : ''  }}>
                            ...
                            <div class="form-group">
                                ...
                                @php
                                    $cottages_array = [];
                                    foreach ($transaction->cottages as $key => $value) {
                                        $cottages_array[] = $value->id;
                                    }
                                @endphp
                                        ...
                                        <div class="col-lg-4">
                                            <label class="selectgroup-item" style="width: inherit;">
                                                <input type="checkbox" name="cottages[]" value="{{ $cottage->id }}"
                                                    class="selectgroup-input" {{ in_array($cottage->id, $cottages_array) ? 'checked' : ''  }}>
                                ...
                                {{-- <div class="selectgroup selectgroup-pills">
                                    @foreach ($cottages as $cottage)
                                        <label class="selectgroup-item" style="width: inherit;">
                                            <input type="checkbox" name="cottages[]" value="{{ $cottage->id }}" class="selectgroup-input" {{ in_array($cottage->id, $cottages_array) ? 'checked' : ''  }}>
                            ...
                            <div class="form-group">
                                ...
                                @php
                                    $rooms_array = [];
                                    foreach ($transaction->rooms as $key => $value) {
                                        $rooms_array[] = $value->id;
                                    }
                                @endphp
                                        ...
                                        <div class="col-lg-4">
                                            <label class="selectgroup-item" style="width: inherit;">
                                                <input type="checkbox" name="rooms[]" value="{{ $room->id }}"
                                                    class="selectgroup-input" {{ in_array($room->id, $rooms_array) ? 'checked' : ''  }}>
                                                <span class="selectgroup-button"
                                                    style="height: 100%; border-radius: 0.25rem !important;">
                                                    <b>{{ $room->name }}</b>
                                ...
                                {{-- <div class="selectgroup selectgroup-pills">
                                    @foreach ($rooms as $room)
                                        <label class="selectgroup-item" style="width: inherit;">
                                            <input type="checkbox" name="rooms[]" value="{{ $room->id }}" class="selectgroup-input" {{ in_array($room->id, $rooms_array) ? 'checked' : ''  }}>
        ...
        $( document ).ready(function() {
            $.ajax({
                ...
                success: function (result) {
                    ...
                    $element.append(option);
                    $element.val({{ $transaction->client_id }}); // Select the option with a value of '1'
