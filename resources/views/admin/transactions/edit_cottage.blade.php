                                    ...
                                    <form id="msform" autocomplete="off">
                                            ...
                                            <div class="form-card text-left">
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        ...
                                                        <p class=""><strong>Cottage:</strong> <span class="">{{ $transaction->cottage->name }}</span></p>
                                                    </div>
                                                    <div class="col-lg-6">
                                                        ...
                                                        <div
                                                            ...
                                                            <label class="selectgroup-item pb-0">
                                                                <input type="radio" name="type" value="day" data-sched="{{ config('yourconfig.resort')->day }}"
                                                                    class="selectgroup-input day" {{ $transaction->type == 'day' ? 'checked' : '' }}>
                                        ...
                                        <fieldset>
                                            ...
                                            <input type="button" name="previous"
                                                ...
                                                value="Previous" />
                                            <button name="next" class="second-next next action-button btn btn-primary">Next Step</button>
                                        </fieldset>
                                        <fieldset>
                                            <div class="form-card text-left">
                                                <div class="row">
            ...
            if(checkin == "") {
                ...
                $.ajax({
                    ...
                    data: {
                        ...
                        type: type,
                        edit: 1,
                        cottageid: "{{ $transaction->cottage_id }}",
                    },
                    headers: {
